...
/**
 * Lucide-style stroke icon set (24x24 grid). Replaces emoji UI glyphs so the
 * app renders identically across platforms and inherits theme colors.
 */
const ICONS: Record<string, string> = {
  ...
  'bookmark-filled':
    '<path fill="currentColor" d="m19 21-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"/>',
  share:
...
export class IconComponent implements OnChanges {
  ...
  ngOnChanges() {
    this.paths = this.sanitizer.bypassSecurityTrustHtml(ICONS[this.name] || '');
  }
}
